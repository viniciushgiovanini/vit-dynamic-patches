...
class CustomConv2D(nn.Module):
    ...
    def forward(self, x, image_name):
        ...
        lista_centro_dict = self.load_dict("data/centros_pre_salvos/segmentacao_dicionario.pkl")
...
if __name__ == '__main__':
    ...
    custom_conv = CustomConv2D(input_channels=3, output_channels=768, patch_size=(16,16))
