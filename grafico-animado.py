...
def update_graph(frame):
    ...
    try:
        ...
        ax2.plot(
            resultados["epoch"], resultados["train_loss"], label="Train Loss"
        )
        ax2.plot(
            resultados["epoch"], resultados["val_loss"], label="Validation Loss"
        )
...
ani = animation.FuncAnimation(
    plt.gcf(), update_graph, interval=1000
